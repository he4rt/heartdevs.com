@php
    ...
    $scoreBadgeColor = $topScore >= 0.7 ? 'red' : ($topScore >= 0.4 ? 'amber' : 'green');
...
>
    ...
    <div class="mb-1.5 flex items-center gap-2">
        ...
        <flux:badge size="sm" color="{{ $statusColor }}">{{ $case->status->getLabel() }}</flux:badge>
    ...
    <div class="flex items-center gap-2.5 text-[11px]">
        ...
        <span class="font-mono text-zinc-400 dark:text-zinc-500"> {{ '@' . ($case->author?->name ?? '?') }} </span>
