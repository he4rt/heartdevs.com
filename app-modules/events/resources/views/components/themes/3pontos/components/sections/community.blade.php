<section class="hp-section">
    <div class="hp-container grid grid-cols-1 items-start gap-x-12 lg:grid-cols-[1fr_4fr]">
        ...
        <div class="grid grid-cols-1 gap-8 lg:col-span-2 lg:grid-cols-8 lg:gap-4">
            <x-he4rt::card class="relative overflow-hidden lg:col-span-5">
            ...
            <x-he4rt::card class="lg:col-span-3">
                ...
                <x-slot:description>
                    ...
                    outros profissionais estão acessíveis. Faça conexões genuínas, encontre mentores, colabore em
                    projetos e expanda sua rede de forma orgânica e significativa.
                </x-slot>
            </x-he4rt::card>

            <x-he4rt::card class="relative overflow-hidden lg:col-span-3">
