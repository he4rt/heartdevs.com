    ...
    <div class="hp-container relative z-10">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-4">
            ...
            <x-he4rt::card class="hover:border-b-outline-light border-b-8">
                ...
                <x-slot:description class="pb-4 text-center">
                    Há mais de uma década unindo tecnologia, criatividade e impacto social. Evangelista de Tecnologia
                    focada em fortalecer comunidades dev e ampliar o acesso à educação tecnológica por meio de
                    workshops, mentorias e iniciativas premiadas.
                </x-slot>
            </x-he4rt::card>
            ...
            <x-he4rt::card class="hover:border-b-outline-light border-b-8">
                ...
                <x-slot:description class="pb-4 text-center">
                    Linha de frente na criação de softwares e fortalecendo comunidades dev. DevRel focado em conteúdo
                    técnico, live coding e educação, sempre impulsionando novos talentos. Fundador da He4rt Developers e
                    apaixonado por ensinar, programar e construir espaços onde desenvolvedores crescem juntos.
                </x-slot>
            </x-he4rt::card>
