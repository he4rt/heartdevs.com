    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
        @foreach ($events as $event)
            ...
            >
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <x-filament::icon-button
                                icon="heroicon-m-eye"
                                href="{{\He4rt\Events\Filament\App\EventModels\EventModelResource::getUrl('show', ['record' => $event->getKey()])}}"
                                tag="a"
                                label="Filament"
                            />
                        </div>
                ...
                <div class="fi-section-content flex h-full flex-col justify-between">
                    <div>
                    ...
                    <div>
                        <div class="text-muted-foreground mt-2 space-y-2 text-xs">
                            ...
                            <div class="m-t flex items-center gap-2">
