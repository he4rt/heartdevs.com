<x-filament-panels::page>
    {{-- PROTOTYPE — 3 variants of the timeline feed, switchable via ?variant=A|B|C --}}
    @php
        $mockUsers = [
    ...
    @if ($variant === 'B')
        @include ('panel-app::prototype.variant-b')
    @elseif ($variant === 'C')
        @include ('panel-app::prototype.variant-c')
    @else
        @include ('panel-app::prototype.variant-a')
    @endif

    @include ('panel-app::prototype.switcher', ['current' => $variant])
</x-filament-panels::page>
